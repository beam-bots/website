...
**Breaking change**: If you've written custom commands, they need updating. The `handle_command` callback works differently now. Check the [commands tutorial](https://beam-bots.dev/docs/tutorials/05-commands/) for the new pattern.
