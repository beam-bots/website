...
The new `bb_ik_fabrik` package implements the [FABRIK algorithm](https://www.andreasaristidou.com/FABRIK.html) for inverse kinematics. Instead of saying "rotate joint 1 to 45 degrees, joint 2 to 30 degrees...", you can say "put the gripper at position (x, y, z)" and the solver figures out the joint angles.
